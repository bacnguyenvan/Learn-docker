...
class LandmarkController extends Controller
{
     ...
     *              @OA\Property(property="category", type="string", example="iste"),
     *              @OA\Property(property="address", type="string", example="23691 Flatley Loaf\\nNew Lonie, MN 38407-5431"),
     *              @OA\Property(property="tel", type="integer", example="370.903.1827 x52"),
     ...
     *    @OA\JsonContent(
     *       required={"name", "description", "thumbnail", "latitude", "longitude", "category", "address", "tel"},
     *       @OA\Property(property="name", type="string", example="tempore"),
     *       @OA\Property(property="description", type="string", example="et"),
