...
class RouteController extends Controller
{
     ...
     *    description="Insert route",
     *    @OA\JsonContent(
     *       required={"area_id","number","name","description","movement","stamina_level","range","max_elevation","journey_time","line_color"},
     *       @OA\Property(property="area_id", type="number", example=1),
     *       @OA\Property(property="number", type="number", example=1),
     *       @OA\Property(property="name", type="string", example="example"),
     *       @OA\Property(property="description", type="text", example="description"),
     ...
     * )
     */
    public function update(RoutePutRequest $request, \App\Models\Route $route)
    {
