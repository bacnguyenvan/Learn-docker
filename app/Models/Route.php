...
class Route extends Model
{
    ...
    protected $with = ['area', 'activities', 'tags', 'points', 'landmarks', 'stamps', 'scenes', 'warnings'];
    ...
    public function searchByActivity($request)
    {
        ...
        if(isset($request->movement) && $request->movement != 'composite'){
            $query = $query -> where('routes.movement',$request->movement);
        }
